...
Enter frequency of purchase: 501

Optimal BST Rebuilt Successfully!
Minimum Search Cost = 501
...
Short Algorithm for Optimal Binary Search Tree (OBST)

1. Start the program.
2. Initialize arrays for product names and frequencies.
3. Display menu for:
    * Insert Product
    * Delete Product
    * Display Products
...
4. Input product name and frequency.
5. Store product data in arrays.
6. Sort products alphabetically.
7. Build Optimal BST using dynamic programming.
8. Construct tree from root table.

⸻

Delete Product

9. Input product name to delete.
10. Search product in array.
11. Remove product and shift remaining elements.
12. Rebuild OBST and reconstruct tree.

⸻

Display Products

13. Perform inorder traversal of tree.
14. Display products in sorted order.
